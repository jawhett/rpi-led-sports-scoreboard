...
class NFLFavTeamNextGameScene(FavTeamNextGameScene):
    """ Favourite team next game scene for the NFL. Contains functionality to pull schedule data from NFL API, parse, and build+display images based on the result.
