...
class NFLStandingsScene(StandingsScene):
    """ Standings scene for the NFL. Contains functionality to pull standings data from NFL API, process as needed, and build+display images based on the result.
    ...
    def __init__(self):
        ...
        self.COLOURS.update({
            'sidebar_highlight': (0, 53, 148) # NFL blue.
        })
